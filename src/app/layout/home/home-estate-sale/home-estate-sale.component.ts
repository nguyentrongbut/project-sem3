...
@Component({
    selector: 'app-home-estate-sale',
    standalone: true,
    imports: [BtnNextSwiperComponent, BtnPrevSwiperComponent],
    templateUrl: './home-estate-sale.component.html',
    styleUrl: './home-estate-sale.component.css',
    schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class HomeEstateSaleComponent implements OnInit {
